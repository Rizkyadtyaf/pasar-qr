...
import { ShoppingBag, Tag, Package } from 'lucide-react-native';

interface TemplateDownloadProdukQRProps {
  qrValue: string;
  productName: string;
  productPrice?: number;
  productImage?: string;
...
export interface TemplateDownloadProdukQRRef {
  downloadQRCode: () => Promise<any>;
}

const TemplateDownloadProdukQR = forwardRef<TemplateDownloadProdukQRRef, TemplateDownloadProdukQRProps>((props, ref) => {
  const { qrValue, productName, productPrice, productImage, containerStyle } = props;
  ...
  return (
    <View ref={qrRef} style={[styles.container, containerStyle]}>
      ...
      <View style={styles.footer}>
        <Text style={styles.scanText}>Scan untuk melihat produk</Text>
...
TemplateDownloadProdukQR.displayName = 'TemplateDownloadProdukQR';

export default TemplateDownloadProdukQR;